...
class LoginPageForOfficer extends StatefulWidget {
  @override
  _LoginPageForOfficerState createState() => _LoginPageForOfficerState();
}

class _LoginPageForOfficerState extends State<LoginPageForOfficer> with TickerProviderStateMixin{
      ...
      child: ElevatedButton(
          ...
          onPressed: () async{
           ...
           if(isValid){
             ...
             Navigator
                 .push(context, MaterialPageRoute(builder: (context) => EcgOfficerSide()));
           }
          }
      ),
    );
